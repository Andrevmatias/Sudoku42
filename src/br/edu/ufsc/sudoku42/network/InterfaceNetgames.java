...
public class InterfaceNetgames implements OuvidorProxy {
	...
	public void conectar(String nomeJogador) throws NetworkException{
		try {
			...
			throw new NetworkException("O jogo j� foi conectado", e);
		} catch (NaoPossivelConectarException e) {
			throw new NetworkException("N�o foi poss�vel conectar", e);
		} catch (ArquivoMultiplayerException e) {
			throw new NetworkException("Ocorreu um erro ao tentar ler o arquivo de configura��o \"jogoMultiPlayer.properties\"", e);
		}
	}
